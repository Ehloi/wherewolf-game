...
class RoleAttributes {
  private constructor(public readonly name: RoleName, public readonly description: RoleDescription, public readonly isGood: boolean, public readonly isUnique: boolean) {}

  static readonly VILLAGER: RoleAttributes = { name: RoleName.VILLAGER, description: RoleDescription.VILLAGER, isGood: true, isUnique: false };
  static readonly WEREWOLF: RoleAttributes = { name: RoleName.WEREWOLF, description: RoleDescription.WEREWOLF, isGood: false, isUnique: false };
  static readonly TALKATIVE_WOLF: RoleAttributes = { name: RoleName.TALKATIVE_WOLF, description: RoleDescription.TALKATIVE_WOLF, isGood: false, isUnique: true };
  static readonly BLACK_WOLF: RoleAttributes = { name: RoleName.BLACK_WOLF, description: RoleDescription.BLACK_WOLF, isGood: false, isUnique: true };
  static readonly SEER: RoleAttributes = { name: RoleName.SEER, description: RoleDescription.SEER, isGood: true, isUnique: true };
  static readonly DRUNK_VILLAGER: RoleAttributes = { name: RoleName.DRUNK_VILLAGER, description: RoleDescription.DRUNK_VILLAGER, isGood: true, isUnique: true };
  static readonly WITCH: RoleAttributes = { name: RoleName.WITCH, description: RoleDescription.WITCH, isGood: true, isUnique: true };
  static readonly LITTLE_GIRL: RoleAttributes = { name: RoleName.LITTLE_GIRL, description: RoleDescription.LITTLE_GIRL, isGood: true, isUnique: true };
  static readonly HUNTER: RoleAttributes = { name: RoleName.HUNTER, description: RoleDescription.HUNTER, isGood: true, isUnique: true };
  static readonly THE_RED_RIDING_HOOD: RoleAttributes = { name: RoleName.THE_RED_RIDING_HOOD, description: RoleDescription.THE_RED_RIDING_HOOD, isGood: true, isUnique: true };
  static readonly GUARD: RoleAttributes = { name: RoleName.GUARD, description: RoleDescription.GUARD, isGood: true, isUnique: true };
  static readonly CUPID: RoleAttributes = { name: RoleName.CUPID, description: RoleDescription.CUPID, isGood: true, isUnique: true };
  static readonly DICTATOR: RoleAttributes = { name: RoleName.DICTATOR, description: RoleDescription.DICTATOR, isGood: true, isUnique: true };
}
